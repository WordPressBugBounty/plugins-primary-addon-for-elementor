    ...
    */
    protected function render() {
        ...
        <div class="napae-pricing-table napae-pricing-table-style-<?php echo esc_attr($pricing_style); ?>">
            ...
            <div class="napae-pricing-table-badge"><?php echo esc_html( $settings['badge_text'] ); ?></div>
            <?php } ?>
            <div class="napae-pricing-table-wrapper">
                <?php if( $settings['title'] ) { ?>
                    <div class="napae-pricing-table-header-wrapper">
                        <div class="napae-pricing-table-header"><?php echo esc_html($settings['title']); ?></div>
                    </div>
                <?php } ?>
                <?php if( $settings['price'] ) { ?>
                    <div class="napae-pricing-table-price-wrapper">
                        <div class="napae-pricing-table-price-inner">
                            <span class="napae-pricing-table-price">
                                <?php if( $settings['currency'] ) { ?>
                                    <span class="napae-pricing-table-currency"><?php echo esc_html($settings['currency']); ?></span>
                                <?php } ?>
                                <?php echo esc_html($settings['price']); ?>
                            </span>
                            <?php if( $settings['period'] ) { ?>
                                <span class="napae-pricing-table-period"><?php echo esc_html($settings['period']); ?></span>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
                        ...
                        <?php foreach ( $settings['features_list'] as $index => $feature ) : ?>
                            <li class="">
                                ...
                                if ( ! empty( $feature['selected_icon']['value'] ) ) :
                                    echo '<i class="'.esc_attr( $feature["selected_icon"]["value"] ).'"></i>';
                                endif; 
                ...
                <?php endif; ?> 
                <?php if($button_link) { ?>
                    <div class="napae-pricing-table-footer">
                        <a href="<?php echo esc_url($button_link); ?>" class="napae-pricing-btn" <?php echo esc_attr( $button_link_attr ); ?>><?php echo esc_html($button_text); ?></a>
                    </div>
                <?php } ?>
            </div>
        </div>
